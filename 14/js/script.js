...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_prizes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/prizes */ "./source/js/view/prizes.js");
/* harmony import */ var _view_prizes_number__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/prizes-number */ "./source/js/view/prizes-number.js");
/* harmony import */ var _view_game_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/game-timer */ "./source/js/view/game-timer.js");
  ...
  for (let i = 0; i < menuLinks.length; i++) {
    menuLinks[i].addEventListener(`click`, function (evt) {
      ...
      if (isCurrentMenuLinkPrizes) {
        Object(_view_prizes__WEBPACK_IMPORTED_MODULE_0__["default"])();
        Object(_view_prizes_number__WEBPACK_IMPORTED_MODULE_1__["resetPrizesNumber"])();
        ...
        if (prizesCasesNumberElement) {
          prizesCasesNumberElement.parentElement.addEventListener(`animationend`, () => {
            Object(_view_prizes_number__WEBPACK_IMPORTED_MODULE_1__["prizesCasesNumberAnimate"])();
          });
        }

        if (prizesCodesNumberElement) {
          prizesCodesNumberElement.parentElement.addEventListener(`animationend`, () => {
            Object(_view_prizes_number__WEBPACK_IMPORTED_MODULE_1__["prizesCodesNumberAnimate"])();
          });
        }
      ...
      if (isCurrentMenuLinkGame) {
        Object(_view_game_timer__WEBPACK_IMPORTED_MODULE_2__["default"])();
      }
    });
  }
});
...
/***/ "./source/js/modules/textLettersAnimation.js":
/*!***************************************************!*\
  !*** ./source/js/modules/textLettersAnimation.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TextLettersAnimation; });
class TextLettersAnimation {
  constructor(
      elementSelector,
      animationDuration,
...
/* harmony import */ var _modules_textLettersAnimation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/textLettersAnimation */ "./source/js/modules/textLettersAnimation.js");
/* harmony import */ var _view_prizes__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./view/prizes */ "./source/js/view/prizes.js");
/* harmony import */ var _view_prizes_number__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./view/prizes-number */ "./source/js/view/prizes-number.js");
// modules
...
const animatedSlogan = new _modules_textLettersAnimation__WEBPACK_IMPORTED_MODULE_9__["default"](
    `.js-intro-title`,
...
const animatedDate = new _modules_textLettersAnimation__WEBPACK_IMPORTED_MODULE_9__["default"](
    `.js-intro-date`,
    LETTERS_ANIMATION_PARAMETERS.animationDuration,
    LETTERS_ANIMATION_PARAMETERS.animationTimeInterval,
    LETTERS_ANIMATION_PARAMETERS.cssClassForActivateAnimation,
...
if (isCurrentLocationPrizes) {
  Object(_view_prizes__WEBPACK_IMPORTED_MODULE_10__["default"])();
  ...
  if (prizesCasesNumberElement) {
    prizesCasesNumberElement.parentElement.addEventListener(`animationend`, () => {
      Object(_view_prizes_number__WEBPACK_IMPORTED_MODULE_11__["prizesCasesNumberAnimate"])();
    });
  }

  if (prizesCodesNumberElement) {
    prizesCodesNumberElement.parentElement.addEventListener(`animationend`, () => {
      Object(_view_prizes_number__WEBPACK_IMPORTED_MODULE_11__["prizesCodesNumberAnimate"])();
    });
  }
}
...
/***/ "./source/js/view/prizes-number.js":
/*!*****************************************!*\
  !*** ./source/js/view/prizes-number.js ***!
  \*****************************************/
/*! exports provided: prizesCasesNumberAnimate, prizesCodesNumberAnimate, resetPrizesNumber */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "prizesCasesNumberAnimate", function() { return prizesCasesNumberAnimate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "prizesCodesNumberAnimate", function() { return prizesCodesNumberAnimate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetPrizesNumber", function() { return resetPrizesNumber; });
function prizesCasesNumberAnimate() {
  const prizesCasesNumberElement = document.querySelector(`.js-prizes-item-cases-number`);
...
function prizesCodesNumberAnimate() {
  const prizesCodesNumberElement = document.querySelector(`.js-prizes-item-codes-number`);
